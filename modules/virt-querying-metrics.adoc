...
// CNV-71499: Updated recording rule names to adhere to Prometheus naming conventions
// Old: kubevirt_vmsnapshot_disks_restored_from_source
// New: vm:kubevirt_vmsnapshot_disks_restored:sum
`vm:kubevirt_vmsnapshot_disks_restored:sum`::
Returns the total number of virtual machine disks restored from the source virtual machine. Type: Gauge.

// CNV-71499: Updated recording rule names to adhere to Prometheus naming conventions
// Old: kubevirt_vmsnapshot_disks_restored_from_source_bytes
// New: vm:kubevirt_vmsnapshot_restored_bytes:sum
